...
import utils
from perturbation.sliding_window import SlidingWindowPerturbation
...
def main():
    ...
    pert = SlidingWindowPerturbation(model, x_t, device, ground_truth)
    threshold = 0.001
    ...
    utils.save_importance_grid(X1, pert_result, "window_importance_map_grid",
                               "Perturbation of channels using sliding window")
